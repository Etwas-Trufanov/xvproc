...
| Десятичный код | Шестнадцатеричный | Двоичный | Символ | Описание |
|----------------|-------------------|----------|--------|----------|
...
| 34 | 0x22 | 00100010 | " | Double quotes |
...
| 46 | 0x2E | 00101110 | . | Period |
| 47 | 0x2F | 00101111 | / | Slash |
...
### Примечания:
1. Коды 0-31 и 127 - управляющие символы (непечатаемые)
2. Коды 32-126 - печатаемые символы
3. Коды 48-57 - цифры (0-9)
4. Коды 65-90 - заглавные буквы английского алфавита
5. Коды 97-122 - строчные буквы английского алфавита
